/**
 * Client-safe mapping of coin symbols to image URLs.
 * Used across dashboard, assets, and markets pages for consistent coin avatars.
 */
...
export const COIN_IMAGES: Record<string, string> = {
  ...
  RNDR: "https://coin-images.coingecko.com/coins/images/11636/small/rndr.png",
  ...
  ANIME: "https://coin-images.coingecko.com/coins/images/53575/small/anime.jpg",
  SOLV: "https://coin-images.coingecko.com/coins/images/27987/small/solv.jpg",
  ...
  BLUR: "https://coin-images.coingecko.com/coins/images/28453/small/blur.png",
  ...
  W: "https://coin-images.coingecko.com/coins/images/35087/small/W_Token_%283%29.png",
  STRK: "https://coin-images.coingecko.com/coins/images/26433/small/starknet.png",
  DYM: "https://coin-images.coingecko.com/coins/images/34182/small/dym.png",
  MEME: "https://coin-images.coingecko.com/coins/images/32528/small/memecoin_%282%29.png",
  POPCAT: "https://coin-images.coingecko.com/coins/images/33760/small/image.jpg",
  MEW: "https://coin-images.coingecko.com/coins/images/36440/small/MEW.png",
  BRETT: "https://coin-images.coingecko.com/coins/images/35529/small/1000017839.png",
  MOTHER: "https://coin-images.coingecko.com/coins/images/38269/small/mother.png",
  TRUMP: "https://coin-images.coingecko.com/coins/images/53746/small/trump.png",
  MELANIA: "https://coin-images.coingecko.com/coins/images/53769/small/melania.png",
  AI16Z: "https://coin-images.coingecko.com/coins/images/51090/small/AI16Z.jpg",
  FARTCOIN: "https://coin-images.coingecko.com/coins/images/50891/small/fart.jpg",
  kBONK: "https://coin-images.coingecko.com/coins/images/28600/small/bonk.jpg",
  kPEPE: "https://coin-images.coingecko.com/coins/images/29850/small/pepe-token.jpeg",
  kSHIB: "https://coin-images.coingecko.com/coins/images/11939/small/shiba.png",
  kFLOKI: "https://coin-images.coingecko.com/coins/images/16746/small/PNG_image.png",
}

/** Get a coin image URL by symbol with a ui-avatars.com fallback */
export function getCoinImage(symbol: string): string {
  return COIN_IMAGES[symbol] || ""
}

/** Generate a fallback avatar URL for a given symbol */
export function coinFallback(symbol: string): string {
  return `https://ui-avatars.com/api/?name=${encodeURIComponent(symbol)}&size=64&background=random&bold=true&color=fff`
}

/** onError handler for coin image elements */
export function handleCoinImageError(e: React.SyntheticEvent<HTMLImageElement>, symbol: string) {
  ;(e.target as HTMLImageElement).src = coinFallback(symbol)
}
