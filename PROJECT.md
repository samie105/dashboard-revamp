...
# Privy Wallets
# Legacy / old users continue using the existing Privy credential set.
PRIVY_APP_ID=...
PRIVY_APP_SECRET=...

# New users created after this rollout use the new Privy credential set.
NEW_PRIVY_APP_ID=...
NEW_PRIVY_APP_SECRET=...

# The app uses `privy_type` to route existing users to old or new Privy.
# - 0 = old privy
# - 1 = new privy
