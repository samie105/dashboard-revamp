...
export default function VividVoiceControl() {
  ...
  return (
    <>
      ...
      {/* Status pill */}
      {isActive && (
        <div className="fixed bottom-22 right-6 z-50 flex items-center gap-1.5 rounded-full bg-card/90 backdrop-blur-sm px-2.5 py-1 text-[11px] font-medium text-foreground/90 shadow-lg border border-border max-sm:bottom-19 max-sm:right-4 max-sm:scale-90 max-sm:origin-bottom-right select-none pointer-events-none">
